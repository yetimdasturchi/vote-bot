...
|
*/
$config['base_url'] = isset($GLOBALS['system_config']['base_url']) ? $GLOBALS['system_config']['base_url'] : '';
...
|
*/
$config['language']	= isset($GLOBALS['system_config']['language']) ? $GLOBALS['system_config']['language'] : 'english';
