...
class Edit_model extends CI_Model {
		...
		if ( $this->form_validation->run() ) {
			...
			return $this->output
		    	...
		    	->set_output(json_encode([
		        	...
		        	'reset' => false,
		        	'messages' => [
		        		'addedd' => lang('channel_successfully_edited')
		        	],
	...
	public function set_rules(){
		...
		$this->form_validation->set_rules('chat_id', lang('channel_chat_id'), 'required|min_length[4]|max_length[32]');
...
/* Location: ./application/models/channels/Edit_model.php */