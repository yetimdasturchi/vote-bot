...
class Edit_model extends CI_Model {
	...
	public function process( $id, $data ){
		...
		if ( $this->form_validation->run() ) {
            ...
            $this->db->update('poll_questions', [
            	'name' => $name,
				'question' => $question,
        		'file' => isset( $file_id ) && !empty( $file_id ) ? json_encode($file_id) : $data['file'],
			...
			return $this->output
                ...
                ->set_output(json_encode([
                    'status' => true,
                    'messages' => [
                        'addedd' => lang('polls_successfully_updated')
                    ],
...
/* Location: ./application/models/polls/inline/Edit_model.php */