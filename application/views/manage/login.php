                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            <h5 class="text-primary"><?php echo lang('login_header');?></h5>
                                ...
                                <div class="p-2">
                                    <div class="form-horizontal">
                                        <div class="mt-3 d-grid">
                                            <button class="btn btn-primary waves-effect waves-light" id="login" type="submit"><?php echo lang('login_signin');?></button>
                                            <style type="text/css">
                                                iframe{
                                                    display: none;
                                                }
