    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="ajax-form" method="POST" action="<?php echo base_url('polls/web/add');?>" autocomplete="off">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" min="1" max="100" name="polls_check" class="form-control" id="formrow-polls_check" value="1" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <select class="select2 form-control select2-multiple" name="polls[]" multiple="multiple" data-placeholder="<?php echo lang('polls_choose');?>" data-params="<?php echo htmlspecialchars(  json_encode($slect2Params), ENT_QUOTES, 'UTF-8' ); ?>"></select>
                            ...
                            <div class="row d-none polls-translations d-none-select2">
                                <div class="col-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="select2 form-control select2-multiple" name="polls_uzbek[]" multiple="multiple" data-placeholder="<?php echo lang('polls_choose');?>" data-params="<?php echo htmlspecialchars(  json_encode($slect2Params), ENT_QUOTES, 'UTF-8' ); ?>"></select>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="mb-3">
                                        <label for="formrow-polls_uzbek_cyr" class="form-label">Ўзбек</label>
                                        <select class="select2 form-control select2-multiple" name="polls_uzbek_cyr[]" multiple="multiple" data-placeholder="<?php echo lang('polls_choose');?>" data-params="<?php echo htmlspecialchars(  json_encode($slect2Params), ENT_QUOTES, 'UTF-8' ); ?>"></select>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="mb-3">
                                        <label for="formrow-polls_russian" class="form-label">Русский</label>
                                        <select class="select2 form-control select2-multiple" name="polls_russian[]" multiple="multiple" data-placeholder="<?php echo lang('polls_choose');?>" data-params="<?php echo htmlspecialchars(  json_encode($slect2Params), ENT_QUOTES, 'UTF-8' ); ?>"></select>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="mb-3">
                                        <label for="formrow-polls_english" class="form-label">English</label>
                                        <select class="select2 form-control select2-multiple" name="polls_english[]" multiple="multiple" data-placeholder="<?php echo lang('polls_choose');?>" data-params="<?php echo htmlspecialchars(  json_encode($slect2Params), ENT_QUOTES, 'UTF-8' ); ?>"></select>
                                    </div>
                                </div>
                            </div>
