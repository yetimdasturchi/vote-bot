                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18"><?php echo lang('polls_memebers');?></h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"><?php echo lang('polls_nominations');?></a></li>
                                            <li class="breadcrumb-item active"><?php echo lang('polls_memebers');?></li>
                                        </ol>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <?php 
                                            $dataParams = [
                                                ...
                                                'ajax' => [
                                                    'url' => base_url('polls/web/members/'.$contest . '/' . $id .'/getlist'),
                                                    'cache' => false,
                                                    'data' => 'function(data){data.contest = '.$contest.';data.nomination = '.$id.';}'
                                                ],
                                                'columns' => [
                                                    ['title' => lang('polls_id'), 'data' => 'id'],
                                                    ['title' => lang('polls_image'), 'data' => 'image'],
                                                ...
                                                'buttons' => [
                                                    ...
                                                    [
                                                        ...
                                                        'action' => 'function(e,dt,node,config){ window.location.href = "'.base_url('polls/web/members/'.$contest . '/' . $id .'/add').'" }'
                                                    ]
                                                ]
                                            ];
                                        ...
                                        ?>
                                        <table class="table table-striped dt-responsive table-sm nowrap w-100" data-datatable="polls_web_members" data-params="<?php echo $dataParams; ?>"></table>
