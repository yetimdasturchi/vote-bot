                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18"><?php echo lang('polls_contests');?></h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"><?php echo lang('polls');?></a></li>
                                            <li class="breadcrumb-item active"><?php echo lang('polls_contests');?></li>
                                        </ol>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <?php 
                                            $dataParams = [
                                                ...
                                                'ajax' => [
                                                    'url' => base_url('polls/web/records/getlist'),
                                                    'cache' => false,
                                                ],
                                                'columns' => [
                                                ...
                                                'buttons' => [
                                                    ...
                                                    [
                                                        ...
                                                        'action' => 'function(e,dt,node,config){ window.location.href = "'.base_url('polls/web/add').'" }'
                                                    ]
                                                ]
                                            ];
